	...
	namespace SchemaOffsets {
		namespace particles {
			...
			namespace C_OP_RemapScalarOnceTimed /*: public CS2::particles::CParticleFunctionOperator*/ {
				constexpr std::ptrdiff_t m_bProportional = 0x1d8; // bool m_bProportional; |  0x1d8 | Schema_Builtin | Size: 0x1
				...
				constexpr std::ptrdiff_t m_flRemapTime = 0x1f4; // float32 m_flRemapTime; |  0x1f4 | Schema_Builtin | Size: 0x4
			}
		}
	}
}
