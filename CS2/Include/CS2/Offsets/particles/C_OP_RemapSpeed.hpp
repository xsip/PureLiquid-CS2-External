...
namespace CS2 {
	namespace SchemaOffsets {
		namespace particles {
			// Class size: 0x1F8
			namespace C_OP_RemapSpeed /*: public CS2::particles::CParticleFunctionOperator*/ {
				...
				constexpr std::ptrdiff_t m_nSetMethod = 0x1ec; // particleslib::ParticleSetMethod_t  | Schema_DeclaredEnum | Size: 0x4
				constexpr std::ptrdiff_t m_bIgnoreDelta = 0x1f0; // bool m_bIgnoreDelta; |  0x1f0 | Schema_Builtin | Size: 0x1
			}
		}
	}
}
