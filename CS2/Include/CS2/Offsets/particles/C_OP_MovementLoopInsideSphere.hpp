	...
	namespace SchemaOffsets {
		namespace particles {
			...
			namespace C_OP_MovementLoopInsideSphere /*: public CS2::particles::CParticleFunctionOperator*/ {
				...
				constexpr std::ptrdiff_t m_vecScale = 0x350; // particleslib::CParticleCollectionVecInput  | Schema_DeclaredClass | Size: 0x6b8
				constexpr std::ptrdiff_t m_nDistSqrAttr = 0xa08; // particles::ParticleAttributeIndex_t  | Schema_DeclaredClass | Size: 0x4
			}
		}
	}
}
