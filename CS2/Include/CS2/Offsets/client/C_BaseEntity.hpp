	...
	namespace SchemaOffsets {
		namespace client {
			...
			namespace C_BaseEntity /*: public CS2::entity2::CEntityInstance*/ {
				constexpr std::ptrdiff_t m_CBodyComponent = 0x30; // client::CBodyComponent**  | Schema_Ptr | Size: 0x8
				...
				constexpr std::ptrdiff_t m_bAnimTimeChanged = 0x5e1; // bool m_bAnimTimeChanged; |  0x5e1 | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_bSimulationTimeChanged = 0x5e2; // bool m_bSimulationTimeChanged; |  0x5e2 | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_sUniqueHammerID = 0x5f0; // GlobalTypes::CUtlString  | Schema_Atomic | Size: 0x8
				constexpr std::ptrdiff_t m_nBloodType = 0x5f8; // client::BloodType  | Schema_DeclaredEnum | Size: 0x4
			}
		}
	}
}
