...
namespace CS2 {
	namespace particles {
		...
		public:
			...
			PROPERTY(m_bBackwards,bool, 0x1ec);
			PROPERTY(m_nSetMethod,IDENTITY(particleslib::ParticleSetMethod_t), 0x1f0);
			S2_PAD(0x20);
		};
#ifdef USE_STATIC_ASSERTS
		//static_assert(sizeof(CS2::particles::C_OP_RemapParticleCountOnScalarEndCap) == 0x1F8, "C_OP_RemapParticleCountOnScalarEndCap size should be 0x1F8");
