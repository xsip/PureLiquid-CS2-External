...
namespace CS2 {
	namespace particles {
		...
		public:
			...
			PROPERTY(m_fl4NoiseScale,float32, 0x1e4);
			PROPERTY(m_bAdditive,bool, 0x1e8);
			PROPERTY(m_flNoiseAnimationTimeScale,float32, 0x1ec);
			S2_PAD(0x18);
		};
#ifdef USE_STATIC_ASSERTS
		//static_assert(sizeof(CS2::particles::C_OP_Noise) == 0x1F0, "C_OP_Noise size should be 0x1F0");
