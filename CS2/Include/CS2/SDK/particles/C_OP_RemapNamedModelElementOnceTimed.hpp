...
namespace CS2 {
	namespace particles {
		...
		public:
			...
			PROPERTY(m_bProportional,bool, 0x229);
			...
			PROPERTY(m_flRemapTime,float32, 0x234);
			S2_PAD(0x60);
		};
#ifdef USE_STATIC_ASSERTS
		//static_assert(sizeof(CS2::particles::C_OP_RemapNamedModelElementOnceTimed) == 0x238, "C_OP_RemapNamedModelElementOnceTimed size should be 0x238");
