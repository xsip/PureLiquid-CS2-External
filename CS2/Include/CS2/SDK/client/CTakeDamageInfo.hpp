...
namespace CS2 {
	namespace client {
		...
		public:
			...
			// PROPERTY(m_DestructibleHitGroupRequests,IDENTITY(GlobalTypes::CUtlLeanVector<client::DestructiblePartDamageRequest_t>), 0x100);
			PROPERTY(m_bInTakeDamageFlow,bool, 0x110);
			S2_PAD(0x118);
		};
#ifdef USE_STATIC_ASSERTS
		//static_assert(sizeof(CS2::client::CTakeDamageInfo) == 0x118, "CTakeDamageInfo size should be 0x118");
